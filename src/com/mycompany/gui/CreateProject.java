...
public class CreateProject extends BaseForm {
    ...
    public CreateProject(com.codename1.ui.util.Resources resourceObjectInstance) {
    ...
    com.codename1.ui.TextField minB = new com.codename1.ui.TextField();
    com.codename1.ui.TextField maxB = new com.codename1.ui.TextField();
...
////       
        ...
        gui_Component_Group_1.addComponent(minB);
        gui_Component_Group_1.addComponent(maxB);
        ...
        String ch;
        ch=minB.getText();
        Double dmin= Double.parseDouble(ch);
        String chh;
        chh=maxB.getText();
        Double dmax= Double.parseDouble(chh);
        
        
            ProjectF t = new ProjectF(gui_Text_Field_1.getText(), dmin, projectDescription.getText(), dmax,gui_Text_Field_2.getText(),"2010-10-26",datepiker.getDate().toString(),"fatma@gmail.com",2,2);
            ser.createProject(t);
